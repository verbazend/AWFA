<?php /* Smarty version 2.6.26, created on 2013-04-09 04:53:39
...
<?php endif; ?> (<?php echo ((is_array($_tmp='General_Default')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
)</option>
...
" border="0" /> <?php echo ((is_array($_tmp='General_Delete')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
				...
				<td><a href='<?php echo smarty_function_url(array('module' => 'CoreAdminHome','action' => 'trackingCodeGenerator','idSite' => $this->_tpl_vars['site']['idsite'],'updated' => false), $this);?>
...
<br />
	...
	<table style='width:600px' class="adminTable" >
		...
		<tr><td>
			...
			<input type="checkbox" id="globalKeepURLFragments" name="globalKeepURLFragments" <?php if ($this->_tpl_vars['globalKeepURLFragments']): ?>checked="checked"<?php endif; ?>/>
