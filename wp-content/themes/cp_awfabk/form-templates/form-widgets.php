...
wp_enqueue_script( 'od_cform_js', get_stylesheet_directory_uri() . '/form-templates/form-F2-js.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker' ), '1.0.0', false );
...
public function cd_form_footer_hook(){
	...
	include("sidebar-miniform.php");
	echo('</div><input class="axcelerateCourseID" type="hidden" name="courseid" value="" /><input type="hidden" name="form_id" value="axcelerate_booking_form_form" />');
