...
jQuery(function($){
	...
	$('.axcelerateState').change(function() {
        ...
        $.get(baseHTTSpath + "/axcelerate/drill/" + $(this).val(), function(data) {
    ...
    $('.axcelerateLocation').change(function() {
        ...
        $.get(baseHTTSpath + "/axcelerate/drill/" + $('.axcelerateState').val() + '/' + $(this).val(), function(data) {
    ...
    $('.axcelerateCourse').change(function() {
        $('.axcelerateCourseID, .axcelerateCourseDate').val('');
        address = baseHTTSpath + "/axcelerate/drill/" + $('.axcelerateState').val() + "/" + $('.axcelerateLocation').val() + '/' + $(this).val();
...
function miniEnrolNow(){
	...
	if(courseID){
		document.location = "https://www.australiawidefirstaid.com.au/enrol-now/?cid="+courseID;
	} else {
