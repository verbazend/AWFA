...
var baseHTTSpath = "http://awfa.vbz.com.au/booking-manager/";
var campaignstring = "";
...
function miniEnrolNow(){
	...
	if(courseID){ 
		...
		document.location = "http://awfa.vbz.com.au/enrol-now/?cid="+courseID + campaignstring_sub;
	} else {
