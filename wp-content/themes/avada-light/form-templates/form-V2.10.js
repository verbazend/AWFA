...
jQuery(function($){
	...
	var courseLocationDetails = "<div class='courselocationdetails'>Provide First Aid (including CPR) in Brisbane CBD</div>";
   ...
   function openCouresSelector(){
   			...
   			$.each($courseDates, function(index,value) {
            	...
            	if(datetoms(jsDate) < datetoms(js7date)){
            		...
            		if(lastHeader=="thisweek"){
            			...
            			cHTML = cHTML+"<div class='weeksperator'>Courses This Week</div>";
            			lastHeader = "thisweek";
            		}
            		...
            		if(lastHeader=="nextweek"){
            			...
            			cHTML = cHTML+"<div class='weeksperator'>Courses Next Week</div>";
            			lastHeader = "nextweek";
            		}
            	} else {
            		// is later
            		...
            		if(lastHeader=="later"){
            			...
            			if(currentMonth==lastmonth){
            				...
            				cHTML = cHTML+"<div class='weeksperator'>Courses In "+getMonthFullName(currentMonth)+"</div>";
            			}
            			
            			lastmonth = jsDate.getMonth();
            			
            		} else {
            			cHTML = cHTML+"<div class='weeksperator'>Courses Next Few Weeks</div>";
            			lastHeader = "later";
            		}
            	}
            ...
            $(".courseselectionlist").html(courseLocationDetails+cHTML);
