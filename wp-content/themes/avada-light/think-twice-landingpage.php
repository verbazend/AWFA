<?php
// Template Name: Landing Page - Think Twice
...
<head>
  ...
  <meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    ...
    <link rel="stylesheet" href="/lp/j/css/awfa.css<?php echo $cachevar; ?>" type="text/css"> 	 
      ...
      <div class="home-text-wrapper">
      	   <div class="container clearfix">
              <div class="home-quote">
                <h1>
                <span class="slabtext"><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If You Have One,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Think Twice&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div><span></span></span>
        ...
        <div class="container achievements">  
            ...
            <div class="row">
               ...
               <div class="eight columns">
                 <div class="" >
                   <span class="milestone-count highlight">130,000 Children</span>
                   <h6 class="milestone-details">were hospitalised as a result of injury</h6>
                 </div>
               </div><!-- END FOUR COLUMNS -->  

               <div class="eight columns">
                 <div class="" >
                   <span class="milestone-count highlight">20% of hospitalisations</span>
                   <h6 class="milestone-details"> in children aged 1-4 years<br>were caused by falls</h6>
                 </div>
               </div><!-- END FOUR COLUMNS --> 
            ...
            <div class="row">
               ...
               <div class="eight columns">
                 <div class="" >
                   <span class="milestone-count highlight">75% of infant drowning</span>
                   <h6 class="milestone-details">cases were in bathtubs</h6>
                 </div>
               </div><!-- END FOUR COLUMNS --> 
               
               <div class="eight columns">
                 <div class="" >
                   <span class="milestone-count highlight">442 per 100,000</span>
                   <h6 class="milestone-details">young adults (18-24) were involved in a unintentional transport injury </h6>
                 </div>
               </div><!-- END FOUR COLUMNS -->                                                                                   
           </div><!-- END ROW -->
		</div><!-- END CONTAINER --> 
		...
		<div class="container clearfix">
           <div class="row">
			...
			<div class="nine columns">
              <!-- START service-box -->
				<div class="service-box">
                 <!-- START ICON -->
                   <div>
                      <h3>Mrs Smith's Story</h3><!-- END service-box TITLE 
                      <img src="/lp/images/steve.jpg" />-->
                   </div>
                 <!-- END ICON -->  
                 
                <!-- START service-box DESCIPTION --> 
                <div class="service-description" style="margin-bottom:0px !important;">
                ...
                <!--<p>"Quite simply I wouldn't be here if the club didn't have a defibrillator. All sport clubs should have a defib, it saved my life."</p><!-- END service-box DESCRIPTION --> 
	                ...
	                Mrs Smith was at home with her husband on a quiet weeknight.
	                <br><br>"My husband and I were sitting down together to 
	                feed our 8-month old daughter. She was eating some toast fingers as she has many times before.
	                
	                <br><br>She was in her
	                high chair sitting next to me at the table. I got up to go to the kitchen counter and my husband called out her
	                name which I thought was strange. I turned around to see our daughters face red, her eyes watering and she was trying
	                to heave but couldn’t. She couldn’t gag or make a noise.
	                
	                <br><br>Being a nurse, I am the first aider in my family. 
	                I quickly pushed my husband out of the way, unbuckled the high chair, flipped our daughter over and gave her a
	                tap on the back. She started crying.
	                
	                <br><br>I immediately was relived because it meant she was breathing again. 
	                
	                <br><br>For days after this incident, I thought twice "<span style="font-decoration:italic;">what if I didn’t make it home for dinner that night, what if
	                I wasn’t there and my husband didn't know what to do?</span>".
	                </p>
			...
			<div class="seven columns">
				<img style="  border-radius: 3px;" src="/lp/j/images/baby_girl_mrssmith_457.jpg">
			</div>		
		...
		<div class="container">	
           <div class="row">	
			<div class="sixteen columns">            
	            <!-- START TITLE -->	            
				<div class="title">
				  <h1><strong>Think Twice</strong></h1>
                  <div class="subtitle">
                      <p>
                      	If you book 1 adult* into a HLTAID003 Provide First Aid Course, including CPR<br>book a second adult in for half price. 
                      	<br><br>
						Second/Half Price booking can be used within the same class as first participant or in any HLTAID003 Provide First 
						Aid class with Australia Wide First Aid before 31.12.15.<br><br>
						
                      </p>
                      <sub style="font-size:12px;">Adult* 15 years and older<br>First aid training must be completed at same Australia Wide First Aid <a style="color:#626262; text-decoration:underline;" href="https://www.australiawidefirstaid.com.au/course-locations/" target="_blank">venue</a> </sub>
                  </div><!-- END SUBTITLE -->
                </div><!-- END TITLE -->  	                           
			</div><!-- END SIXTEEN COLUMNS -->  
           </div><!-- END ROW -->         
...
<div class="fullwidth grey whatwedo">
        ...
        <div class="fancy-header2">       
           <h2 style="font-size:45px !important;">Book Now and <strong>Protect</strong> your family!</h2>
           <div class="subtitle">
               <p>Think Twice and insure you and your family know how to save a life, it may be yours or your childs life that is saved.</p>
           </div>
        </div>
         ...
         <div class="row">          
                <div class="one-third column columnbutton">
                  ...
                  <div>
                    ...
                    <h3>Enquire Now</h3>                
                    <p>Contact us to arrange your First Aid training</p>
                  </div>   
                  </a>            
                ...
                <div class="one-third column columnbutton">
                  ...
                  <div class="service-features">
                  <div>
                    <img src="/lp/images/location.png" alt="Our Locations">
                  </div>  
                    <h3>Course Locations<div style="background-color: #000000"></div></h3>                
                    <p>Find your nearest training centre</p>
                  </div>   
                  </a>            
                </div><!-- END ONE THIRD COLUMN -->
                
                <div class="one-third column columnbutton">
                  <a target="_blank" href="https://www.australiawidefirstaid.com.au/about-us/">
                  <div class="service-features">
                  <div>
                    <img src="/lp/images/heart.png" alt="About AWFA">
                  </div>  
                    <h3>About AWFA</h3>                
                    <p>Learn about AWFA and how we save lives.</p>
                  </div>   
                  </a>            
                </div><!-- END ONE THIRD COLUMN -->                
            ...
            <div class="row" ID="courselocations">
            	<br>
            	<h2>Our Course Locations</h2>
            	<div class="one-third column" style="color:#fff;">
            		<div>
            				<ul class="barrow">
										<li><a href="#gocourse" onclick="setlocation('Brisbane CBD, Queensland');">Brisbane CBD, Queensland</a></li>
										<li><a href="#gocourse" onclick="setlocation('Sydney CBD, New South Wales');">Sydney CBD, New South Wales</a></li>
										<li><a href="#gocourse" onclick="setlocation('Melbourne CBD, Victoria');">Melbourne CBD, Victoria</a></li>
										<li><a href="#gocourse" onclick="setlocation('Perth CBD, Western Australia');">Perth CBD, Western Australia</a></li>
										</ul>
            		</div>
            	</div>
            	<div class="one-third column" style="color:#fff;">
            		...
            		<div>
            				<ul class="barrow">
										<li><a href="#gocourse" onclick="setlocation('Alexandra Hills, Queensland');">Alexandra Hills, Queensland</a></li>
										<li><a href="#gocourse" onclick="setlocation('Belmont, Western Australia');">Belmont, Western Australia</a></li>
										<li><a href="#gocourse" onclick="setlocation('Browns Plains, Queensland');">Browns Plains, Queensland</a></li>
										<li><a href="#gocourse" onclick="setlocation('Gold Coast, Queensland');">Gold Coast, Queensland</a></li>
										<li><a href="#gocourse" onclick="setlocation('Ipswich, Queensland');">Ipswich, Queensland</a></li>
										</ul>
            		</div>
            	</div>
            	<div class="one-third column" style="color:#fff;">
            		...
            		<div>
            				<ul class="barrow">
										<li><a href="#gocourse" onclick="setlocation('The Grange, Queensland');">The Grange, Queensland</a></li>
										<li><a href="#gocourse" onclick="setlocation('North Lakes, Queensland');">North Lakes, Queensland</a></li>
										<li><a href="#gocourse" onclick="setlocation('Springfield Lakes, Queensland');">Springfield Lakes, Queensland</a></li>
										<li><a href="#gocourse" onclick="setlocation('Toowoomba, Queensland');">Toowoomba, Queensland</a></li>
										<li><a href="#gocourse" onclick="setlocation('Townsville, Queensland');">Townsville, Queensland</a></li>
										</ul>
            		</div>
            	</div>
            </div>  
	...
	<div class="parallax-bg bg4"></div>
        <div class="container clearfix">
         ...
         <div class="contact-details">
           <h2><span>Think Twice, No Second Chance</span><br>
           Are you confident you can save a life?<br>We can help you learn how!<br></h2>		
        </div>			
	    <!-- END CONTACT DETAILS -->
		...
		<div class="container">	
           <div class="row">	
			<div class="sixteen columns">            
	            <!-- START TITLE -->	            
				<div class="title">
				  <h1>Australia's Leader in First Aid Solutions</h1>
  ...
  <div id="contacter-wrapper">
	...
	.arrow {
	  ...
	  width: 40px;
	  height: 40px;
	  background-image: url("/lp/images/landingpage_downarrow.png");
