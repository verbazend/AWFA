...
if(!isset($_GET['sb'])){
	header( 'Location: /enrol-now/?cid='.urlencode($_GET['cid']).'&sb=true&campaign='.urlencode($campaign) ) ;
}
	...
	<div id="content" style="float:left;">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post-content">
				...
				<div class="enrol-error-message" style="display: block;">
					<div class="enrol-error-sadface">!<br>&nbsp<br>&nbsp<br></div>
					<div class="error-header">Important Notice</div> 
					<div class="enrol-error-text">We are currently experiencing issues processing enrolments online due to an issue NAB has <a href="http://www.nab.com.au/about-us/corporate-responsibility/business-alerts?own_cid=shortURL:support" target="_blank" style="color:#fff !important; display:inline-block; margin-left:35px;">reported</a> in processing credit card transactions. Please contact us on <b>1300 336 613</b> to book.</div>
				</div>
			<?php } ?>
				<div class="enrol-section-1">
					...
					<div class="inputitem usiinputitem"><span>USI</span><input type="text" name="usi" placeholder="USI" style="width:90%"> [<a href="http://www.usi.gov.au" target="_blank">?</a>]</div>
					<div class="inputspacer"></div>
	...
	if(true){
		...
		<div id="enrolloading" style="z-index:999999;">
			...
			<div id="progresswrapper">
				<div class="progress-label mainmessage" style="text-align:center; color:#fff;">Processing...</div>
