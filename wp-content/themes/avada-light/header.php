...
<head>
	...
	$gfonts = str_replace("http:","https:",$gfonts);
	?>
	<?php endif; ?>
	...
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/lib/jquery.mousewheel-3.0.6.pack.js"></script>
	
	<!-- Add fancyBox -->
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/source/jquery.fancybox.css?v=2.1.5" type="text/css" media="screen" />
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/source/jquery.fancybox.pack.js?v=2.1.5"></script>
	
	<!-- Optionally add helpers - button, thumbnail and/or media -->
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/source/helpers/jquery.fancybox-buttons.css?v=1.0.5" type="text/css" media="screen" />
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/source/helpers/jquery.fancybox-buttons.js?v=1.0.5"></script>
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/source/helpers/jquery.fancybox-media.js?v=1.0.6"></script>
	
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/source/helpers/jquery.fancybox-thumbs.css?v=1.0.7" type="text/css" media="screen" />
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/source/helpers/jquery.fancybox-thumbs.js?v=1.0.7"></script>
	...
	<script>
	  ...
	  ga('create', 'UA-38203903-1', 'australiawidefirstaid.com.au');
	  ga('set', 'contentGroup1', 'Personal Details Form'); 
	  ga('set', 'contentGroup2', 'Confirming Personal Details'); 
	  ga('set', 'contentGroup3', 'Payment Selection Page'); 
	  ga('set', 'contentGroup4', 'Pay Now Page'); 
	  ga('set', 'contentGroup5', 'Thank You Page');
	  ga('send', 'pageview');
