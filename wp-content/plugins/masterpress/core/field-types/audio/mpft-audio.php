...
class MPFT_Audio extends MPFT_FileBase {
  ...
  */
  ...
  public static function enqueue() {
    MasterPress::enqueue_mediaelement();
  }
  ...
  */
  ...
  public static function __s() {
    return __("Audio", MASTERPRESS_DOMAIN);
  }
  ...
  */
  ...
  public static function __description() {
    return __("A file upload control for audio files", MASTERPRESS_DOMAIN);
  }
...
HTML;
  ...
  */
  ...
  public static function ui_prop() {
    return "source_url,attachment_id,duration";
  }
  ...
  */
  ...
  public static function ui( MEOW_Field $field ) {
    ...
    $prop_inputs = self::prop_inputs($field, "attachment_id,duration");
    ...
    if (!$field->blank()) {
      ...
      if ($file && $file->exists()) {
        ...
        if (strtolower($file->extension()) == "mp3") {
          $player_class = "";
          $player_content = '<audio controls="control" preload="auto" src="'.$file->url().'" type="audio/mp3"></audio>';
        }
...
HTML;
    ...
    <a data-href="{$fileurl}" class="file-info" tabindex="-1" target="_blank">
    ...
    <div class="file-controls">
      <div class="player {$player_class}">$player_content</div>
