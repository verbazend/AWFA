...
class WOOF_Wrap implements arrayaccess {
  ...
  protected function property_cache_key($args) {
  ...
  // property cache
  public function property_cache($property, $value = null) {
    
    $ret = null;
    
    if (!is_null($value)) {
      $this->_pc[$property] = $value;
    }

    if (isset($this->_pc[$property])) {
      $ret = $this->_pc[$property];
    }
  
    return $ret;
  }
  
  public function property_uncache_args($property, $args) {
    $key = $this->property_cache_key($args);
    unset( $this->_pc[$property][$key] );
  }
  
  
  public function property_cache_args($property, $args, $value = null) {
  ...
  public function eval_json_field($name) {
    global $wf;
    return $wf->eval_expression($name, $this);
  }
