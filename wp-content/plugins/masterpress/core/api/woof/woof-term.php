...
class WOOF_Term extends WOOF_Wrap {
  ...
  public function children($args = array()) {
    ...
    if (!$ret = $this->property_cache_args( __FUNCTION__ , $args)) {
      ...
      $this->property_cache_args( __FUNCTION__ , $args, $ret ); 
    }
  ...
  function update($strip = true) {
    ...
    if (!$this->_is_new) { // this term exists already
      wp_update_term($this->item->term_id, $this->taxonomy_name(), (array) $this->item);
