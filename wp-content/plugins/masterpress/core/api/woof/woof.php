  ...
  */
  ...
  class WOOF extends WOOF_Wrap {
    ...
    */
    ...
    public static function eval_expression($expression, $object) {
      return WOOF_Expression::eval_expression($object, $expression);
    }
    ...
    function post_types($arg = null) {
      ...
      if (is_array($arg)) {
        ...
        $this->post_types = $this->wrap_post_types($types);
    ...
    */
    ...
    public function template_for_post($post) {
      ...
      if (is_numeric($post)) {
        ...
        $id = $post;
      } else if (get_class($post) == $this->get_post_class()) {
        $id = $post->id();
      } 
    ...
    function post($id = null, $type = "post") {
      ...
      if (!$id && isset($_POST["post_ID"])) {
        // if we still have no ID, try to look for post_ID, used in the admin quick-edit
        $id = $_POST["post_ID"];  
      }
      ...
      if (isset($id)) {
        ...
        if (is_null($ret = $this->property_cache_args("post", $args))) {
          ...
          if ($po) {
            ...
            $this->property_cache_args( "post", $args, $ret );
    ...
    public function roles() {
      ...
      if (is_null($result = $this->property_cache("roles"))) {
        $result = $this->property_cache("roles", $this->wrap_roles( get_option($table_prefix."user_roles") ));
      }
