...
class WOOF_Post extends WOOF_Wrap {
  ...
  public function permalink($encode = false) {
    ...
    if (is_null($ret = $this->property_cache_args("permalink", $encode))) {
      ...
      $ret = $this->property_cache_args("permalink", $encode, $pl);
    }
  ...
  public function terms($taxonomy = NULL) {
    ...
    if (isset($taxonomy)) {
      return $wf->wrap_terms( get_the_terms($this->id(), $taxonomy) );
    } else {
  ...
  public function meta($key, $single = false) {
    ...
    if ($single) {
      ...
      return new WOOF_SimpleCollection($items);
    }
  ...
  public function related_by_term($args = array()) {
    ...
    return new WOOF_Silent( __("There are no related posts", WOOF_DOMAIN ) );
  }
  ...
  function siblings($include_this = false, $args = array()) {
    ...
    if (is_null($ret = $this->property_cache_args("siblings", array($include_this, $r)))) {
      ...
      $this->property_cache_args("siblings", array($include_this, $r), $ret);
  ...
  function next($args = array()) {
    ...
    return new WOOF_Silent( __("There is no next post", "WOOF_DOMAIN") );
  ...
  function prev($args = array()) {
    ...
    return new WOOF_Silent( __("There is no previous post", "WOOF_DOMAIN") );
  ...
  function ancestors() {
    ...
    if (is_null($ret = $this->property_cache("ancestors"))) {
      ...
      if ($this->hierarchical()) {
	    ...
	    $this->property_cache("ancestors", $ret);
	  }
  ...
  public function parent() {
    ...
    if (is_null($ret = $this->property_cache("parent"))) {
      ...
      $this->property_cache("parent", $ret);
  ...
  function template() {
    ...
    if (is_null($ret = $this->property_cache("template"))) {
      ...
      $this->property_cache("template", $ret);
  ...
  function top() {
    ...
    if (is_null($ret = $this->property_cache("top"))) {
  ...
  function update($strip = true) {
    ...
    if (!$this->_is_new) { // this post exists already
      wp_update_post($this->item);
    } else {
      unset($this->item->ID);
      $this->item->ID = wp_insert_post($this->item);
      $this->_is_new = false;
    }
