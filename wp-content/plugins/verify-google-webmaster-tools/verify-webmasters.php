...
function activate_google_webmaster_tools() {
  add_option('gwebmasters_code', 'google167ce91e6145ba7a.html');
}

function deactive_google_webmaster_tools() {
  delete_option('google167ce91e6145ba7a.html');
}

function admin_init_google_webmaster_tools() {
  register_setting('google_webmaster_tools', 'google167ce91e6145ba7a.html');
}
...
function google_webmaster_tools() {
  $gwebmasters_code = get_option('google167ce91e6145ba7a.html');
?>
