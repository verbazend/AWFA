...
<body style="margin:0px;padding:0px;overflow:hidden">
 <iframe src="" frameborder="0" name="targetvum_player_frame" style="overflow:hidden;height:100%;width:100%" height="100%" width="100%"></iframe>
	<form id="vum_player_frame"  runat="server" target="targetvum_player_frame" method="post" action="<?php echo is_ssl() ? str_replace( 'http://', 'https://', self::vum_domain ) : self::vum_domain; ?>/player-embed.php">
