...
Class Vc_Frontend_Editor {
	...
	function enqueueAdmin() {
		...
		wp_enqueue_script( 'jquery-ui-accordion' );
		wp_enqueue_script( 'jquery-ui-autocomplete' );
		wp_enqueue_script( 'vc_inline_bootstap_js', vc_asset_url( 'lib/bootstrap/js/bootstrap.min.js' ), array( 'jquery' ), '3.0.2', true );
		...
		wp_enqueue_script( 'vc_inline_shortcodes_builder_js', vc_asset_url( 'js/frontend_editor/shortcodes_builder.js' ), array( 'jquery', 'underscore', 'backbone', 'wpb_js_composer_js_tools' ), '1', true );
		wp_enqueue_script( 'vc_inline_models_js', vc_asset_url( 'js/frontend_editor/models.js' ), array( 'vc_inline_shortcodes_builder_js' ), '1', true );
		wp_enqueue_script( 'vc_inline_panels_js', vc_asset_url( 'js/frontend_editor/panels.js' ), array( 'vc_inline_models_js' ), '1', true );
		wp_enqueue_script( 'vc_inline_js', vc_asset_url( 'js/frontend_editor/frontend_editor.js' ), array( 'vc_inline_panels_js' ), '1', true );
		wp_enqueue_script( 'vc_inline_custom_view_js', vc_asset_url( 'js/frontend_editor/custom_views.js' ), array( 'vc_inline_shortcodes_builder_js', 'vc_inline_panels_js' ), '1', true );
		wp_enqueue_script( 'vc_inline_build_js', vc_asset_url( 'js/frontend_editor/build.js' ), array( 'vc_inline_custom_view_js' ), '1', true );
