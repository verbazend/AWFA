...
if ( is_multisite() && pb_backupbuddy::$classes['core']->is_network_activated() && !defined( 'PB_DEMO_MODE' ) ) { // Multisite installation.
	...
	replacement tool to manually upgrade each URL. See the <a href="http://ithemes.com/codex/page/BackupBuddy_Multisite">BackupBuddy Multisite Knowledge Base</a> for additional information.', true );
} else {
