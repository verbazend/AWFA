	...
	$('.home-slide').each(function(){
	 ...
	 var init = function() {	
		  ...
		  function slabTextHeadlines() {
			...
			//console.log($(".home-quote h1").html());
    };
...
/*----------------------------------------------------*/
    ...
    $("#contact form").submit(function() {
				...
				if( $(this).children('.loader').length === 0 ) {
					...
					$(this).append('<div class="loader" style="width:450px; float:right; margin-top:20px;"><img src="/images/loader.gif"></div>');
