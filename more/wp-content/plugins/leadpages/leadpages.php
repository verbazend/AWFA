...
class LeadPages {
    ...
    function update_settings() {
        ...
        if (file_exists($ak)) {
            ...
            if (defined('PRIVATE_LEADPAGES_API_URL')) {
                $old = self::get_api_url();
                if ($old != PRIVATE_LEADPAGES_API_URL) {
                    self::set_api_url(PRIVATE_LEADPAGES_API_URL);
                }
            }
        }
    ...
    public static function set_api_url($url) {
        update_option('leadpages_private_api_url', $url);
    }

    public static function get_api_url() {
        return get_option('leadpages_private_api_url', false);
    }
